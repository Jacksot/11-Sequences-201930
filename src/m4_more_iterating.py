...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [12, 6, 256, 7, 346, 9, 73, 8, 234, 5, 23]
    threshold = 10
    expected = 6
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 4
    actual = count_positive_sines([12, 54, 1, 65, 3, 0, 28])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 151
    actual = sum_first_n([23, 5, 123, 54, 81, 19], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 981
    actual = sum_first_n([7, 823, 75, 66, 10], 5)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
